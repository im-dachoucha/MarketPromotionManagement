        ...
        >
            ...
            <aside class="col-span-2 bg-teal-50 pt-9">
                <div class="flex flex-col items-center gap-16">
                    <div class="flex flex-start"><a class="font-semibold text-xl" href="#"><i class="fa-solid fa-percent"></i> Promotions</a></div>
                    <div class="flex flex-start"><a class="font-semibold text-xl" href="#"><i class="fa-solid fa-people-roof"></i> Managers</a></div>
                    <div class="flex flex-start"><a class="font-semibold text-xl" href="#"><i class="fa-solid fa-right-from-bracket"></i> Log out</a></div>
                </div>
            </aside>
