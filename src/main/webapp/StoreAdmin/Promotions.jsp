                                    ...
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                        ...
                                        <div class="relative">
                                            ...
                                            >
                                                ...
                                                <c:choose>
                                                    <c:when test="${subDpts != null}">
                                                        <c:forEach items="${subDpts}" var="subDpt">
                                                            <option value="${subDpt.getId()}">
                                                                <c:out value="${subDpt.getName()}"/>
                                                            </option>
                                                        </c:forEach>
                                                    </c:when>
                                                </c:choose>
                          ...
                          >
                            ...
                            <span class="relative"><c:out value="${promotion.getState()}"/></span>
                                                        ...
                                                        <td
                                                                class="px-5 py-5 border-b border-gray-200 bg-white text-center text-sm"
                                                        >
                                                            <c:out value="${promotion.getSubdepartment().getName()}"/>
